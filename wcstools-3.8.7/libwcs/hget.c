 ...
 * Subroutine:	str2dec__ (in) converts string to declination in degrees
 ...
 *
 * Jan 19 2000	Return 0 from isnum(), str2ra(), and str2dec__() if string is null
 ...
 * Sep 20 2001	Ignore leading spaces in str2dec__()
 ...
 *
 * Apr 19 2011	In str2dec__(), change comma to space
