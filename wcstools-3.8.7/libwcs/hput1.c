 ...
 * Subroutine:	dec2str__ (out, lstr, dec, ndec) converts Dec from degrees to string
...
void
dec2str__ (string, lstr, dec, ndec)
 ...
 * Jun 24 1998	Add string length to ra2str(), dec2str__(), and deg2str()
 ...
 * Aug 16 1999	Keep angle between -180 and +360 in dec2str__()
 ...
 * Jan 16 2007	Fix bugs in ra2str() and dec2str__() so ndec=0 works
