...

{
	...
	for (i = 0; i < ncol; i++) {
		...
		if (hms[i]) {
		    if (ndec > -1)
			dec2str__ (numstr, 32, dval, ndec);
		    else
			dec2str__ (numstr, 32, dval, 3);
		    }
		else if (ndec > -1)
	...
	for (i = 0; i < ncol; i++) {
	    if (hms[i]) {
		if (ndec > -1)
		    dec2str__ (numstr, 32, colmin[i], ndec);
		else
		    dec2str__ (numstr, 32, colmin[i], 3);
		}
	    else if (ndec > -1)
	    ...
	    if (hms[i]) {
		if (ndec > -1)
		    dec2str__ (numstr, 32, colmax[i], ndec);
		else
		    dec2str__ (numstr, 32, colmax[i], 3);
		}
	    else if (ndec > -1)
